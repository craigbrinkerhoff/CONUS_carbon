...
### NOTE:
#   YOU WILL SEE VARIABLES VARIOUSLY NAMED "*_bugFix" THROUGHOUT. PLEASE SEE THE README FOR MORE, BUT YOUR EXPERIENCE WITH RUNNING THE PIPELINE ON AN HPC MAY VARY.
#   Also see comment on L82
...
mapped_lvlTerminal <- tar_map(
       ...
       tar_target(calibratedParameters, calibrateModelWrapper(hydrography, huc4, glorich_data, C_groundwater, C_atmosphere, emergenceQ, NA, #calibrate model to CO2
                                              ...
                                              cue = tar_cue(mode = "never"), #this had to be done as well when we had to access the temp files for calibrated parameters. For a normal targets run, you shouldn't need this!!!
       ...
       tar_target(map, indvRiverMaps(final, huc4)), #build river network map for fco2
       tar_target(map_k600, indvRiverMaps_k600(final, huc4)), #build river network map for k600
       tar_target(map_pco2, indvRiverMaps_pco2(final, huc4)), #build river network map for pco2
       tar_target(pseudoValidation, grabModelResults(final, huc4)), #combine claibration co2 values with model results
...
mapped_lvlTerminal_bugFix <- tar_map(
       ...
       tar_target(map_k600, indvRiverMaps_k600(final, huc4)),
       tar_target(map_pco2, indvRiverMaps_pco2(final, huc4)),
       tar_target(pseudoValidation, grabModelResults(final, huc4)),
...
mapped_1710a <- tar_map(
       ...
       tar_target(map_k600, indvRiverMaps_k600(final, sub)),
       tar_target(map_pco2, indvRiverMaps_pco2(final, sub)),
       tar_target(pseudoValidation, grabModelResults(final, sub)),
...
list(
  ...
  #combine all basin maps for k600
  tar_combine(combined_rivermaps_k600, list(mapped_lvlTerminal$map_k600,
                                       mapped_lvlTerminal_bugFix$map_k600,
                                       mapped_lvl0$map_k600,
                                       mapped_lvl0_bugFix$map_k600,
                                       mapped_lvl1$map_k600,
                                       mapped_lvl1_bugFix$map_k600,
                                       mapped_lvl2$map_k600,
                                       mapped_lvl2_bugFix$map_k600,
                                       mapped_lvl3$map_k600,
                                       mapped_lvl3_bugFix$map_k600,
                                       mapped_lvl4$map_k600,
                                       mapped_lvl5$map_k600,
                                       mapped_lvl5_bugFix$map_k600,
                                       mapped_lvl6$map_k600,
                                       mapped_lvl6_bugFix$map_k600,
                                       mapped_lvl7$map_k600,
                                       mapped_lvl8$map_k600,
                                       mapped_lvl9$map_k600,
                                       mapped_lvl10$map_k600,
                                       mapped_lvl11$map_k600,
                                       mapped_lvl12$map_k600,
                                       mapped_lvl13$map_k600,
                                       mapped_lvl14$map_k600,
                                       mapped_lvl15$map_k600,
                                       mapped_lvl16$map_k600,
                                       mapped_lvl17$map_k600,
                                       mapped_lvl18$map_k600,                                       
                                       mapped_1710a$map_k600,
                                       mapped_1710b$map_k600), deployment='main', command = list(!!!.x)),
  
  #combine all basin maps for pco2
  tar_combine(combined_rivermaps_pco2, list(mapped_lvlTerminal$map_pco2,
                                       mapped_lvlTerminal_bugFix$map_pco2,
                                       mapped_lvl0$map_pco2,
                                       mapped_lvl0_bugFix$map_pco2,
                                       mapped_lvl1$map_pco2,
                                       mapped_lvl1_bugFix$map_pco2,
                                       mapped_lvl2$map_pco2,
                                       mapped_lvl2_bugFix$map_pco2,
                                       mapped_lvl3$map_pco2,
                                       mapped_lvl3_bugFix$map_pco2,
                                       mapped_lvl4$map_pco2,
                                       mapped_lvl5$map_pco2,
                                       mapped_lvl5_bugFix$map_pco2,
                                       mapped_lvl6$map_pco2,
                                       mapped_lvl6_bugFix$map_pco2,
                                       mapped_lvl7$map_pco2,
                                       mapped_lvl8$map_pco2,
                                       mapped_lvl9$map_pco2,
                                       mapped_lvl10$map_pco2,
                                       mapped_lvl11$map_pco2,
                                       mapped_lvl12$map_pco2,
                                       mapped_lvl13$map_pco2,
                                       mapped_lvl14$map_pco2,
                                       mapped_lvl15$map_pco2,
                                       mapped_lvl16$map_pco2,
                                       mapped_lvl17$map_pco2,
                                       mapped_lvl18$map_pco2,                                       
                                       mapped_1710a$map_pco2,
                                       mapped_1710b$map_pco2), deployment='main', command = list(!!!.x)),

  #combine all basin maps for pco2
  tar_combine(combined_pseudoValidation, list(mapped_lvlTerminal$pseudoValidation,
                                       mapped_lvlTerminal_bugFix$pseudoValidation,
                                       mapped_lvl0$pseudoValidation,
                                       mapped_lvl0_bugFix$pseudoValidation,
                                       mapped_lvl1$pseudoValidation,
                                       mapped_lvl1_bugFix$pseudoValidation,
                                       mapped_lvl2$pseudoValidation,
                                       mapped_lvl2_bugFix$pseudoValidation,
                                       mapped_lvl3$pseudoValidation,
                                       mapped_lvl3_bugFix$pseudoValidation,
                                       mapped_lvl4$pseudoValidation,
                                       mapped_lvl5$pseudoValidation,
                                       mapped_lvl5_bugFix$pseudoValidation,
                                       mapped_lvl6$pseudoValidation,
                                       mapped_lvl6_bugFix$pseudoValidation,
                                       mapped_lvl7$pseudoValidation,
                                       mapped_lvl8$pseudoValidation,
                                       mapped_lvl9$pseudoValidation,
                                       mapped_lvl10$pseudoValidation,
                                       mapped_lvl11$pseudoValidation,
                                       mapped_lvl12$pseudoValidation,
                                       mapped_lvl13$pseudoValidation,
                                       mapped_lvl14$pseudoValidation,
                                       mapped_lvl15$pseudoValidation,
                                       mapped_lvl16$pseudoValidation,
                                       mapped_lvl17$pseudoValidation,
                                       mapped_lvl18$pseudoValidation,                                
                                       mapped_1710a$pseudoValidation,
                                       mapped_1710b$pseudoValidation), deployment='main', command = dplyr::bind_rows(!!!.x, .id = "method")),
  ...
  tar_target(summaryObject, gatherResults(combined_emissions, combined_sources_basin, figModelCompare, combined_basinProperties, combined_basinLakeProperties, combined_sources_by_order,
                                          list(lumped_01, lumped_02, lumped_03, lumped_04, lumped_05, lumped_06, lumped_07, lumped_08, lumped_09, lumped_10, lumped_11, lumped_12, lumped_13, lumped_14, lumped_15, lumped_16, lumped_17, lumped_18))),
  tar_target(calibrationResults, writeCalibParam(combined_calibrationOutput)), #write the calibration parameters to file
  ...
  tar_target(figMainMap_k600, mainMapFunction_k600(combined_rivermaps_k600), deployment='main'),
  tar_target(figMainMap_pco2, mainMapFunction_pco2(combined_rivermaps_pco2), deployment='main'),
  tar_target(figCompareLumped, compareAgainstLumped(path_to_data, shapefile_huc2)),
  tar_target(figPseudoValidation, pseudoValidation(combined_pseudoValidation)),
